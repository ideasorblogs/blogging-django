...
class QuestionForm(forms.ModelForm):
    class Meta:
        model = question
        fields = ('title', 'questions', 'author', 'categorie')
        widgets = {
            ...
            'author': forms.TextInput(attrs={'class': 'w-full p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none', 'id':'author', 'type':'hidden'})
        }